...
The test covers auth, model listing, routing, fallback, model access, budgets, SQLite logs, provider health, customer reports, request activity, and admin summary endpoints.
